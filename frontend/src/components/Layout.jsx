...
export default function Layout() {
  ...
  // Bottom (mobile) nav omits Chat and Alerts — those live in the mobile top bar instead.
  const footerNavItems = navItems.filter((item) => item.label !== 'Chat' && item.label !== 'Alerts');
