...
export default function CommentSection({ postId, disabled }) {
  ...
  return (
    <div>
      ...
      {disabled ? (
        <p className="text-xs text-nebula-muted border-t border-nebula-border pt-3 mt-1 sticky bottom-0 bg-nebula-surface">
