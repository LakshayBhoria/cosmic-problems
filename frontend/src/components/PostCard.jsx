...
import { Heart, MessageCircle, Send, Bookmark, ChevronLeft, ChevronRight, BadgeCheck, MoreHorizontal, Trash2 } from 'lucide-react';
...
export default function PostCard({ post, onChange, onDelete }) {
  ...
  const share = async () => {
    ...
    try {
      if (navigator.share) await navigator.share({ url, title: post.caption || 'Cosmic Problems' });
    ...
    <article className="card overflow-hidden animate-rise">
      ...
      <div className="px-4 py-3">
        <div className="flex items-center gap-4">
          ...
          <button onClick={share} className="flex items-center gap-1.5 group">
