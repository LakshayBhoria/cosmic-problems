...
function ReelItem({ reel, muted, toggleMute }) {
  ...
  return (
    <div className="relative h-[calc(100vh-3.5rem)] md:h-[calc(100vh-4rem)] snap-start flex items-center justify-center bg-black">
      <video
        ref={videoRef}
...
export default function Reels() {
  ...
  return (
    <div className="h-[calc(100vh-3.5rem)] md:h-[calc(100vh-4rem)] overflow-y-scroll snap-y snap-mandatory">
