...
// Audio/video call signaling (WebRTC offer/answer/ICE relay). Media itself
// is peer-to-peer once the call connects — this socket only exchanges the
// handshake, so it's cheap to run alongside the REST API on the same server.
...
require('./sockets/callSignaling').initCallSignaling(io);
